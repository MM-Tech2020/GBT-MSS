...
namespace Client.Controllers
{
    ...
    public class MemebershipstatusController : ApiController
    {
        BusinessMemebershipstatus _BusinessMemebershipstatus;

        public MemebershipstatusController()
        {
            _BusinessMemebershipstatus = new BusinessMemebershipstatus();
        }
        ...
        public HttpResponseMessage getcardDataByCardNo()
        {
            try
            {
                ...
                //}
                var data = _BusinessMemebershipstatus.GetMemberShipStatus();
